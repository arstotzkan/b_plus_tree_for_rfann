...
void print_usage(const char* program_name) {
    std::cout << "Usage: " << program_name << " --input <npy_file> --index <index_path> [--batch-size <size>]" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Example: " << program_name << " --input data/vectors.npy --index data/npy_index.bpt --batch-size 50" << std::endl;
}
